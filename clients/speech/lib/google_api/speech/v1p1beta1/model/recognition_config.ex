...
defmodule GoogleApi.Speech.V1p1beta1.Model.RecognitionConfig do
  ...
  - googleDataCollectionOptIn (GoogleDataCollectionConfig): *Optional* Contains settings to opt-in to allow Google to collect and use data from this request to improve Google&#39;s products and services. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1p1beta1.Model.RecognitionConfig do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"googleDataCollectionOptIn", :struct, GoogleApi.Speech.V1p1beta1.Model.GoogleDataCollectionConfig, options)
    
    
    
    |> deserialize(:"metadata", :struct, GoogleApi.Speech.V1p1beta1.Model.RecognitionMetadata, options)
    
    
    
    
    |> deserialize(:"speechContexts", :list, GoogleApi.Speech.V1p1beta1.Model.SpeechContext, options)
