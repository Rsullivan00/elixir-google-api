...
defmodule GoogleApi.Speech.V1p1beta1.RequestBuilder do
  @moduledoc """
  ...
  def decode(%Tesla.Env{body: body}, struct, dataWrapped: true) do
    Poison.decode(body, as: %GoogleApi.Speech.V1p1beta1.RequestBuilder.DataWrapper{}, struct: struct)
    |> case do
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1p1beta1.RequestBuilder.DataWrapper do
